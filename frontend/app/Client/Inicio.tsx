    ...
    <div className="flex w-full min-h-screen bg-[#FAF9F5] relative">
      ...
      >
        ...
        {chatLog.length === 0 && !cargando && (
          <h1 className="text-[#343A40] text-3xl text-center font-[code] animate-fadeIn px-4">
            ¡Hola! hago recetas
            <TypingText
            ...
            <section key={msg.id}>
              ...
              >
                ...
                {msg.tipo === "texto" && (
                  <div className="flex flex-col items-end justify-right">
                    <div
                      className={`flex-1 p-5 rounded-2xl text-base leading-relaxed ${
                        msg.rol === "usuario"
              ...
              {msg.video ? (
                <div className="w-full mt-5">
                  ...
                  <a
                    href={`https://www.youtube.com/watch?v=${msg.video.video_id}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-1 flex flex-row items-center gap-4 rounded-2xl max-w-md text-black bg-white border border-gray-300 p-4 shadow-lg hover:shadow-xl  hover:scale-101 transition "
                  >
                    <img
                      src={msg.video.miniatura_url}
                      alt=""
