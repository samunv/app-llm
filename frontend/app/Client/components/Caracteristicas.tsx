  ...
  return (
    <section className="flex flex-row justify-between gap-5 mt-6 mb-4 max-w-[750px]">
      <BloqueCaracteristica
        ...
        icono={<FaStar className="text-orange-500" size={28} />}
      />
      <BloqueCaracteristica
        titulo="Multimedia"
        descripcion="Envía imágenes; o vídeos de YouTube de Recetas para obtener un resumen rápido."
        icono={<MdPermMedia className="text-orange-500" size={28}/>}
      />
      <BloqueCaracteristica
        titulo="Nevera"
        descripcion="Recetas adaptadas a los ingredientes de tu nevera."
        icono={<BiSolidFridge className="text-orange-500" size={28}/>}
      />
    </section>
  );
}
...
function BloqueCaracteristica({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-between text-center p-4  rounded-xl shadow-md bg-white border border-gray-300">
      <div>
 <h2 className="font-bold bg-gradient-to-r from-orange-500 to-yellow-300 bg-clip-text text-transparent">{titulo}</h2>
