...
class SolicitudReceta:
    ...
    def __init__(self, comida, modeloIASeleccionado, imagen, tipoImagen, especificaciones: Especificaciones = None, historial=None, perfilUsuario=None):
        self.comida = comida
        ...
        # Perfil del usuario (Diccionario con nombre, alergias, etc.)
        self.perfilUsuario = perfilUsuario or {}